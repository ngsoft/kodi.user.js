...
(function(root, factory){
    ...
    let name = 'asuraui', deps = ['utils', 'emitter', 'mangas', 'gmtools', 'storage'];
...
}(typeof self !== 'undefined' ? self : this, function(exports, utils, emitter, mangas, gmtools, storage, undef){
    ...
    function init(root, overlay, manga){
        ...
        let
                ...
                darkmodebtn = root.getElementById('darkmode'),
                light, dark;
        ...
        Promise.all([
            loadCSS('minidark', 'mini-dark', root.head),
            loadCSS('minilight', 'mini-light', root.head),
            ...
            xlocalStorage.get('darkmode', true).then(flag => {

                darkmodebtn.checked = flag;
                ...
                body.dataset['colorTheme'] = flag ? 'dark' : 'light';
        ...
        function toggleDarkMode(e){
            ...
            let flag = e.target.checked === true;

            xlocalStorage.set('darkmode', flag).then(() => {

                let elem = flag ? dark : light;


                [light, dark].forEach(el => el.remove());
        ...
        constructor(root, _label, total, append = true){
            ...
            this.elements = {
                ...
                progress: createElement('progress', {
                    id: id,
                    class: 'inline primary col-sm-8',
                    value: '0',
                    max: '1000',
                    //style: "width; 85%;"
                }),
                percent: createElement('span', {class: 'percent col-sm-1 col-sm-offset-1'}, '0%'),
                cancelbtn: createElement('button', {class: 'small secondary cancel-btn col-sm-2', disabled: true}, 'Cancel'),
                pcontainer: createElement('div', {
                    class: 'progress-row'
                })
            };
            ...
            const {container, progress, percent, label, cancelbtn, pcontainer} = this.elements;


            container.appendChild(label);
            pcontainer.appendChild(progress);
            pcontainer.appendChild(percent);

            pcontainer.appendChild(cancelbtn);
    ...
    class Overlay {
        ...
        constructor(manga){
            ...
            if (manga instanceof Manga === false)
            {
                throw new TypeError('manga not instance of Manga');
            }
        ...
        static async getInstanceAsync(manga){


            if (manga instanceof Promise)
            {
                manga = await manga;
            }

            return this.getInstance(manga);
        }
        ...
        static getSelection(manga){
            ...
            return new Promise(resolve => {
                ...
                this.getInstance(manga).show().then(instance => {
