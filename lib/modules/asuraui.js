...
(function(root, factory){
    ...
    function init(root, overlay, manga){
        ...
        overlay.progressbar = new ProgressBar(overlay.tabmanager.tabs.download.querySelector('.row'), 'Download Queue');
        ...
        emitter(overlay.tabmanager.tabs.download).on('tab.selected', () => {
