...
(function(root, factory){
    ...
    const {loadCSS, loadHTML, getText} = gmtools.resource;
    ...
    let template = `<!DOCTYPE html><html><head>
                    ...
                    <body>
                        <header>
                            ...
                            <button id="close" title="Close" style="position: absolute; top:0; right:0;">&times;</button>
                        </header>
        ...
        create(){
            ...
            return new Promise(resolve => {
                if (!this.root) {
                    ...
                    // getText('asuraui').then(console.debug);
