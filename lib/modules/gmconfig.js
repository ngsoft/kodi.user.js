...
(function (root, factory) {
    ...
    let name = 'gmconfig', deps = ['utils', 'emitter', 'gmtools', 'kodi', 'notify'];
...
}(typeof self !== 'undefined' ? self : this, function(utils, emitter, gmtools, kodi, notify, undef){
    ...
    <html>
        ...
        <body>
            ...
            css = `
                ...
                iframe#gmconfig_frame{position: fixed; top:5%; left:50%; z-index: 2147483646;transform:translateX(-50%);width: 80%;height: 720px;overflow-y:scroll;}
    ...
    class Configure {
        ...
        static initialize() {
            gmtools.menu.addItem('Configure ' + gmtools.info.script.name, () => {
                if (!Configure.open) Configure.show();
                else Configure.hide();
            }, 'configure');
        }
