            ...
            <div class="container">
                <form>
                    ...
                    <fieldset>
                        ...
                        <div class="row responsive-label">
                            <div class="col-sm-12 col-md-3"><label for="enabled">Enable</label></div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md" style="text-align:right;">
                            <button id="ping" type="button" class="inverse"><span class="pill"></span>Ping</button>
    ...
    async function init(root){
        ...
        emitter(root).on('click', e => {
            ...
            if (e.target.closest('#close')) {
                Configure.hide();
            } else if ((elem = e.target.closest('#ping'))) {

                let pill = elem.querySelector('.pill');
                pill.setAttribute('class', 'pill');

                if (server) {
                    pill.setAttribute('class', 'pill warning');
                    server.ping().then(result => {
                        if (result === true) {
                            pill.setAttribute('class', 'pill success');
                        } else pill.setAttribute('class', 'pill danger');
                    });
                }
