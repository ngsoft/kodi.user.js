                    ...
                    <fieldset>
                        <legend>Servers</legend>
                            ...
                            <div class="row responsive-label">
                                ...
                                <div class="col-sm-12 col-md" style="text-align:right;"><button class="primary" type="submit">Save</button></div>
                            </div>
    ...
    gmtools.menu.addItem('Configure ' + gmtools.info.script.name, () => {
        ...
        let ifr = createElement('iframe', {
            ...
            onload(e){
                ...
                emitter(e.target.contentDocument.querySelector('form')).on('change submit', console.debug);
