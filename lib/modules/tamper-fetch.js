/**
 * Based on https://github.com/trim21/gm-fetch
    ...
    function fetch(input, init){
        return new Promise(function(resolve, reject){
            ...
            xhr_details.onload = function(xhr){
                ...
                let
                        rawResponseHeaders = xhr.responseHeaders || '',
                ...
                var options = {
                    ...
                    url: responseURL(xhr.finalUrl, rawResponseHeaders, parsedResponseHeaders)
            ...
            aborter = root.GM_xmlhttpRequest(xhr_details);
