...
(function (root, factory) {
...
}(typeof self !== 'undefined' ? self : this, function (exports, GM_execute, undef) {
    ...
    function addStyle(css = '') {
        let
            elem = Object.assign(document.createElement('style'), { type: 'text/css', id: '1.' + uniqid() }),
            head = document.getElementsByTagName('head')[0];
        elem.innerHTML = typeof css !== 'string' ? '' : css;
    ...
    exports.getResource = function (resourceName) {
        ...
        if (metadata.resource && metadata.resource[resourceName]) {
            ...
            if (this.supports('GM_getResourceURL')) {
                result = this.getResourceURL(resourceName);
            } else if (this.supports('GM_getResourceText')) {
                let mime;

                try {
                    result = 'data:text/' + /\.(\w+)(?:[?#].*)?$/.exec(result)[1] + ';base64,' + btoa(this.getResourceText(resourceName));
                } catch (e) {
                }
