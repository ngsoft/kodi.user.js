/**
 * Based on https://github.com/mitchellmebane/GM_fetch
...
(function (root, factory) {
    /* globals define, require, module, self, exports, unsafeWindow, URLSearchParams */
    let name = 'gmfetch', deps = ['gmtools'];
    ...
    // no @grant GM_xmlhttpRequest, use original fetch
    if (!gmtools.supports('GM_xmlhttpRequest')) {
        ['Headers', 'Request', 'Response', 'fetch'].forEach(meth => {
            exports[meth] = function (...args) {
                return global[meth].apply(global, args);
            };
    ...
    function fetch(input, init) {
        return new Promise(function (resolve, reject) {
            ...
            xhr_details.onload = function (xhr) {
                ...
                options.url = 'responseURL' in xhr ? xhr.finalUrl : options.headers.get('X-Request-URL');
            ...
            if ('responseType' in xhr_details) {
                if (support.blob) {
            ...
            aborter = gmtools.xmlhttpRequest(xhr_details);
