...
(function (root, factory) {
    /* globals define, require, module, self, exports, unsafeWindow, URLSearchParams, GM_xmlhttpRequest */
    let name = 'gmfetch', deps = [];
    ...
    function fetch(input, init) {
        return new Promise(function (resolve, reject) {
            ...
            aborter = GM_xmlhttpRequest(xhr_details);
    ...
    function fetch_timeout(input, init){

        let controller, promise, timeout = 30000, id;
        if (init instanceof Object)
        {

            if (init.timeout)
            {
                if (init.timeout / 60 > 1)
                {
                    init.timeout *= 1000;
                }
            ...
            if (init.signal instanceof AbortController)
            {
