        ...
        getImages(){
            ...
            return new Promise((resolve, reject) => {
                ...
                if (t.data.images.length < 1) {
                    ...
                    fetch(t.url, {headers: {Referer: location.origin + '/'}})
                ...
                this.getImages().then(images => {
                    ...
                    Promise.allSettled(images.map((url, index) => {
                        return new Promise((resolve, reject) => {
                            ...
                            fetch(url, {headers: {'Content-Type': 'image/jpeg,image/png', Referer: location.origin + '/'}})
                                    .then(handleFetchError)
                        ...
                        imgs = imgs.map(img => img.value).filter(img => {
