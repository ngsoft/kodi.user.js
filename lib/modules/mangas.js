...
(function(root, factory){
    ...
    class Chapter {
        ...
        getPDF(progress){
            ...
            return new Promise((resolve, reject) => {
                ...
                this.getImages().then(images => {
                    ...
                    Promise.all(images.map((url, index) => {
                        return new Promise((resolve, reject) => {
                            ...
                            fetch(url, {referrer: this.url, headers: {'Content-Type': 'image/jpeg,image/png'}})
                                    .then(handleFetchError)
                        ...
                        this.createPDF(images).then(resolve).catch(reject);
                    }).catch(reject);
        ...
        constructor(url, label, getImgFn){
            ...
            this.data = {url, label, images: [], imagesData: {}};
