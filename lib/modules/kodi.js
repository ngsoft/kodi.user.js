...
(function (root, factory) {
...
}(typeof self !== 'undefined' ? self : this, function (exports, jsonrpc) {
    ...
    class Server {
        ...
        */
        ...
        setCredentials(user, password) {
            ...
            } else this._params.user = this._params.auth = this._params.rpc = null;
        ...
        send(method, params = null) {
            this._params.rpc = this._params.rpc || new JsonRPCRequest(this.address, this.headers);
            return this._params.rpc.send(method, params);
        }
    ...
    s.player.ping().then(console.debug);
