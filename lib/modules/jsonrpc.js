...
(function (root, factory) {
                ...
                gmfetch
                    ...
                    .then(resp => {
                        ...
                        if (resp.status >= 200 && resp.status < 300) {
                            // its a notification without response
                            if (!hasID) {
                                rsl();
                            }
                            return resp.json();
                        }
                        return rej(new Error('Invalid status code :' + resp.status));
                    })
                    .then(obj => {
                        let resp = new Response(obj);
                        if (resp.error) {
                            console.error(this, reqst, resp);
    ...
    Object.assign(exports, { Response, Request, Client, ResponseError, ErrorCodes, ErrorMessages });
