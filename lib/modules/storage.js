...
(function (root, factory) {
...
}(typeof self !== 'undefined' ? self : this, function (exports, gmtools, emitter, undef) {
    ...
    // todo: remove use of emitter(direct call to listener)
    ...
    class ValueChangeEmitter {
        ...
        get gmSupport() {
            ...
            if (typeof this._gmSupport === 'undefined') {
                this._gmSupport =
                    gmtools.supports('GM_addValueChangeListener', 'GM_removeValueChangeListener', 'GM_setValue', 'GM_deleteValue');
            }
        ...
        offValueChange(name, listener) {
            ...
            if (Array.isArray(this._listeners[name])) {
                ...
                this.listeners[name] = this.listeners[name].filter(obj => {
                    if (obj.type === type) {
        ...
        triggerValueChange(name, oldValue, newValue) {
            ...
            if (!this.listeners[name] || this.listeners[name].length === 0) return this;
