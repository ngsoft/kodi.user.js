...
(function (root, factory) {
    ...
    const { isString, isFunction, document } = utils;
    ...
    */
    function isValidSelector(selector) {
        ...
        try {
            ...
            valid =
                ...
                document.createElement('template').querySelector(selector) === null;
        } catch (e) {
            valid = false;
        }
        return valid;
    ...
    function finder(root) {
        ...
        function findOne(selector, callback) {
            ...
            if (!isFunction(callback) && isValidSelector(selector)) {
                return new Promise(rsl => {
